...
/********** STUFF FOR COLLISION DECTECTION ********/
		...
		iObjectId++ )
	{
		...
		// This defaults to checking circles, but change the #if below to do rectangle checks instead
#if 0
...
/***** This code shows how to use the MovementPosition object *****/
/* First set up the movement, then ask it for the position. Check for it finishing, and if so then set up a new movement. */
