...
public:
	...
	DisplayableObject* cloneObject() { return new DisplayableObject(*this); }
	...
	int getDrawingRegionLeft() { return m_iCurrentScreenX + m_iStartDrawPosX; }

	// Get position of right side of shape
	int getDrawingRegionRight() { return m_iCurrentScreenX + m_iStartDrawPosX + m_iDrawWidth; }

	// Get position of top of shape
	int getDrawingRegionTop() { return m_iCurrentScreenY + m_iStartDrawPosY; }

	// Get position of bottom of shape
	int getDrawingRegionBottom() { return m_iCurrentScreenY + m_iStartDrawPosY + m_iDrawHeight; }
	...
	virtual bool deleteOnRemoval() { return true; } 
